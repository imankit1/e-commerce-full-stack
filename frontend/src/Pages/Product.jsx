    ...
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      {/* =-------------------------Product Info  ------------------*/}
        <div className='flex-1'>
          ...
          <div className='text-sm text-gary-500 mt-5 flex flex-col'>
            ...
            <div className="mt-20">
              ...
              <div className='flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500'>
                <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Beatae dolorum deleniti blanditiis sequi ut expedita, libero fuga dolor, fugit inventore dicta ipsam aspernatur consectetur hic? Neque eligendi blanditiis explicabo voluptatibus.</p>
                <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Illo ipsa totam rerum mollitia cumque officia! Nostrum reprehenderit, itaque unde voluptatibus nemo consequuntur, quo quisquam cupiditate quam laboriosam, laborum nam! Voluptas!</p>
              </div>
            </div>
