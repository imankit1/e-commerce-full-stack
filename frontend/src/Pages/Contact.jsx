    ...
    <div>
      ...
      <div className='my-10 flex flex-col justify-center md:flex-row gap-10 mb-28'>
        ...
        <div className='flex flex-col justify-center items-start gap-6'>
          ...
          <p className='text-gray-500'>123 Fashion Street,<br/>Hyderabad, IND 10001, India</p>
          <p className='text-gray-500'> Tel: (415) 5554-6666 <br/> Email: forevercontact@forever.com</p>
